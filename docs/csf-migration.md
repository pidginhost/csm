...
```bash
# Can you SSH in?
ssh -p 2325 root@cluster6.pidginhost.net
...
# Test phclient unban API (from pidginhost.com server)
curl -sk -H "Authorization: Bearer $CSM_AUTH_TOKEN" \
  "https://cluster6.pidginhost.net:9443/api/v1/firewall/check?ip=8.8.8.8"
```
