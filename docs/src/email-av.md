...
- `email_content` - scans outbound email body for credentials and suspicious URLs; base64 bodies and parts are decoded with the same tolerance as attachments
