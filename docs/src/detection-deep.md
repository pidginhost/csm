...
| Check | Description |
|-------|-------------|
| `wp_core` | Core file integrity via official WordPress.org checksums. A command timeout does not mark files as verified, and a timed-out re-check stays unresolved. |
