...
var settingsSections = []SettingsSection{
	...
	},
	{
		...
		Fields: []SettingsField{
			...
			{YAMLPath: "account_scan_max_files", Type: "int", Label: "Account scan max files", Min: int64p(1), Max: int64p(100000), FieldGroup: FieldGroupLimits, Help: "Per-cycle cap for account-scoped scanner paths. Default 10000. Raise on very large multi-tenant hosts."},
