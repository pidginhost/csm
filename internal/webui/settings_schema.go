...
var settingsSections = []SettingsSection{
	...
	},
	{
		...
		Fields: []SettingsField{
			...
			{YAMLPath: "syslog_messages_tail_lines", Type: "int", Label: "Syslog messages tail lines", Min: int64p(10), Max: int64p(100000), FieldGroup: FieldGroupScanIntervals, Help: "Trailing lines of /var/log/messages read only by the legacy nil-store FTP path. The daemon's FTP brute-force detector follows the log forward-only and uses ftp_fail_window_min instead. Default 200."},
