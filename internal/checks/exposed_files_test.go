...
func TestClassifyExposedFile(t *testing.T) {
	cases := []struct {
		...
		{"database.sql.old", classDBDump},
		{"database.sql~", classDBDump},
		{"database.sql.7z", classDBDump},
		{"postgres.dump.zst", classDBDump},
		{"postgres.dump.rar", classDBDump},
		{"site.mysql.xz", classDBDump},
		...
		{"full-site.tar.gz", classBackupArchive},
		{"public_html-backup.zip.old", classBackupArchive},
		{"example.com-backup.zip", classBackupArchive}, // domain name is not proof of a sample
		...
		{"wp-config.php.bak.old", classConfigLeak},
		{"wp-config.php.save1", classConfigLeak},
		{"wp-config.php.2024", classConfigLeak},
		...
		{"info.php", classNone}, // ambiguous application endpoint, not proof of phpinfo
		...
		{".env.php", classNone},      // dotenv-like name, but final .php executes
		{".env.local.phtml", classNone},
		...
		{"fullcalendar.zip", classNone},
		{"dumpster.zip", classNone},
		{"immigration.zip", classNone},
		{"duplicator-pro.zip", classNone},
		{"updraftplus.zip", classNone},
		{"wpvivid-backuprestore.zip", classNone},
		{"all-in-one-wp-migration.zip", classNone},
		{"wordpress-6.8.zip", classNone},        // stock WordPress release, not a site backup
		{"wp-config-sample.php.old", classNone}, // renamed core sample is still benign
		{"wp-config-sample.php.old.bak", classNone},
