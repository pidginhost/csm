...
var realtimeOnlyRules = map[string]string{
	"backdoor_cron_reverse_shell":      "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	"backdoor_iconcache":               "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	...
	"backdoor_systemd_service":         "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	"backdoor_wp_muplugin_loader":      "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	"cgi_bash_webshell":                "Tier 2: base64+eval+Content-type at min_match 3; 186 port-induced live hits on WordPress core PHP, .js bundles and .mo/.po catalogues",
	...
	"exploit_wp_xmlrpc":                "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	"gsocket_persistence":              "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	...
	"miner_coinhive_js":                "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	...
	"obfuscation_assert_string":        "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	"obfuscation_compact_unpack":       "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	...
	"obfuscation_ionCube_fake":         "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	...
	"php_open_basedir_override":        "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	...
	"webshell_litespeed_backdoor":      "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
	...
	"wp_core_file_modify":              "Tier 1: silent on the clean corpus and on a 291k-file live sample; ready to port",
