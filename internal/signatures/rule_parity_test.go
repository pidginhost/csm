...
var realtimeOnlyRules = map[string]string{
	...
	"obfuscation_create_function":     "Tier 2: realtime ties execution evidence to the body argument. obfuscation_create_function_exec in YARA only accepts an empty parameter string and a narrower set of body sources, so it does not cover all realtime variants",
