...
var realtimeOnlyRules = map[string]string{
	...
	"obfuscation_create_function":     "Rename, not a gap: obfuscation_create_function_exec uses the same body-argument predicate, including nonempty parameter lists and decoded or request-controlled bodies; shared positive and benign fixtures exercise both engines",
