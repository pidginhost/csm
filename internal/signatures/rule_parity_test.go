...
var realtimeOnlyRules = map[string]string{
	...
	"spam_pharma_generic":              "Rename, not a gap: spam_pharma now reads the same drug list, and its position arms cover every ordering of the three signals this rule spells out, so porting it would double-report",
