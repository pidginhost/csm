...
- Unsafe subnet-escalation and permanent-block counts are now rejected while their feature is on instead of being silently replaced. Omitted values expose their defaults, automatic block durations must be positive, and the dashboard validates the merged drop-in result before saving.
