...
- Oversized executable files staged during WordPress updates retain their content evidence and the severity of webshell findings.
...
- Reprocessing the same WordPress update snapshot no longer reports a legitimate move into place as a self-deleting file.
