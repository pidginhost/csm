...
- Web UI Findings page moves the on-demand account scan into a modal, opens row details in the shared side panel instead of expanding the table, and surfaces bulk fix/dismiss in a sticky action bar that appears once a row is selected.
