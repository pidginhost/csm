...
- SIEM export honored its time window only on UTC hosts; on any other timezone it returned hours of extra history. Time filters now normalize to one clock before seeking.
