...
- Account-scan truncated findings now name the account whose scan tripped the cap. Operators can target the right tenant or threshold instead of seeing a host-wide total with no attribution.
