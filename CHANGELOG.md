...
- HTTP scanner, request-flood, and UA-spoof source IPs now build local attack reputation, so repeat offenders feed the threat score and repeat-offender blocking instead of being forgotten between scans.
