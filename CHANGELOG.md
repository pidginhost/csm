...
- JavaScript keyboard-handler discovery now handles parenthesized callbacks and ignores spread arguments that do not occupy the event and callback positions.
