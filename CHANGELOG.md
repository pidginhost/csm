...
- The YARA-X worker crash alert no longer says scanning has recovered; it is raised before the restart and now states that scanning is offline until a restarted worker stays up.
