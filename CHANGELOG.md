...
- YARA IPC server now caps frames per connection so a malicious or wedged peer cannot pin one worker goroutine with an endless small-frame stream. Default ceiling is well above legitimate scan traffic.
