...
- Hidden-link database checks preserve supported CSS syntax and match the parser when adjacent content samples are joined. Selection stays bounded without slowing ordinary scans.
