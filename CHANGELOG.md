...
- Daemon shutdown now cancels an in-flight security scan instead of waiting for the whole scan cycle to finish, so stop and restart are no longer delayed by tens of seconds; shutdown phases are logged with timing.
