...
- The finding history and attack event log no longer leave their database pages half empty, so they take roughly half the space in the state file. Existing files shrink after the next compaction.
