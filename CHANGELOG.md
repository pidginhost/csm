...
- Concurrent browser requests no longer reject or delete active sessions when activity arrives out of order. Reauthentication now stops on session lookup failures instead of leaving the previous login active.
