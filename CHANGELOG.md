...
- Web UI navigation is reorganised into a workflow-grouped sidebar (Overview, Triage, Response, Operations, Configuration); URLs are unchanged and the sidebar collapses into a drawer on tablet/mobile viewports.
