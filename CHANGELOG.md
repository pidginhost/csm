...
- The XMRig miner-reference signature no longer flags the coincidental string "xmrig" inside embedded base64 or minified assets such as SVG icons; it now requires accompanying mining context (pool, protocol, algorithm, or CLI flag).
