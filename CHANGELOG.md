...
- The real-time PHP webshell detector no longer silently caps its input at 64 KiB; the upstream read window is the authoritative cap and any future caller passing a larger buffer is now fully scanned instead of having its tail discarded.
