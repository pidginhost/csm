...
- `waf_rules` no longer false-positives during cPanel's nightly `modsec_assemble` window; the check now requires two consecutive negative observations before alerting.
