...
- A plugin update in progress opened one realtime warning for every file in the package. Files staged by an update are now checked against the plugin's official release, the same way installed files already were.
