...
- Forensic snapshots now reject unsafe schema archive names, preserve valid cPanel database names that contain `@`, and keep mail / CageFS private paths out of the recent-file list.
