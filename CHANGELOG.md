...
- PAM helper socket now sets both send and receive timeouts. A hung CSM daemon can no longer freeze a login by accepting the connection and stalling before reading the notification.
