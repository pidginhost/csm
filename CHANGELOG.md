...
- A crafted PHP file can no longer stall the suspicious-content scanner with an assert() argument wrapped in tens of thousands of parentheses; the classifier peels a bounded number of layers and keeps such a call flagged.
