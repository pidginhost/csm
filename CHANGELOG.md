...
- Joomla archive checks no longer combine unrelated folders or mistake directories and links for site files. Confirmed evidence is retained if scanning is interrupted.
