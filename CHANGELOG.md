...
- The daemon no longer promises that the state database will be compacted at the next restart when most of the file is still in use. That restart skipped the compaction, so the message repeated with no effect.
