...
- Linux container checks now use the exact declared Go release and keep host module caches read-only while sharing separate writable caches across worktrees.
