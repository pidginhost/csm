...
- Upgrade rollback no longer deletes live assets it never backed up, keeps restoring past individual failures, and re-applies the binary's immutable flag when it was set before the upgrade.
