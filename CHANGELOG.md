...
- Firewall recovery now runs before startup changes and remains available after startup failure. Resolving an action preserves proven outcomes on storage errors and reports unreadable committed state.
