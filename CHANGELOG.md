...
- YARA carry-forward now preserves every prior rule match for an unexamined file across equivalent path spellings, and ambiguous file-type changes retain the affected scan range rather than retiring findings without coverage.
