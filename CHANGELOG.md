...
- The Re-check action now applies a demotion, and reverses one when the file stops being inert, instead of computing the verdict and discarding it. An operator who cleaned a file by hand was told the finding was still present and saw nothing change.
