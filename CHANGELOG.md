...
- JavaScript keylogger analysis now keeps object fields, array elements, spreads, and JSON serialization distinct, so clean sibling data and cyclic alternatives no longer hide or invent network flows.
