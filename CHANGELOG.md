...
- Finding observer panics now log the recovered value, observer id, and stack to stderr. A recurring observer bug surfaces in the daemon log instead of being silently swallowed.
