...
- Suppressed findings now remain eligible for incident and central threat responses, including IP blocks discovered during database checks. Matching alerts and database changes stay suppressed.
