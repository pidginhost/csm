...
- Files deleted together with their directory, such as a translation pack WordPress unpacks and discards during an update, are reported once for the directory instead of once per file, including when ignored files are filtered out of a larger burst.
