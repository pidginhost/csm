...
- The capability list now advertises the timed firewall rollback and the DoS-exempt ranges, so a panel can feature-detect both instead of sniffing the version.
