...
func runUpdateRules() {
	...
	count, err := signatures.Update(cfg.Signatures.RulesDir, cfg.Signatures.UpdateURL, cfg.Signatures.SigningKey, signatures.UpdateOptions{
		AllowRuleCountDecrease: cfg.Signatures.AllowRuleCountDecrease,
	})
	if err != nil {
