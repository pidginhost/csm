...
ReadWritePaths=/var/lib/csm /var/log/csm /etc/csm /opt/csm/quarantine /opt/csm/policies
ReadWritePaths=/opt/csm/rules -/opt/csm/deploy.sh -/home /tmp /var/tmp -/dev/shm
ReadWritePaths=-/etc/audit/rules.d -/etc/apache2/conf.d/modsec -/usr/local/apache/conf
