...
# Compile YARA-X v1.16.0 static library, install to /usr/local. The
...
# Keep this branch in lockstep with the yara-x/go module version in
# go.mod — the Go bindings reference C symbols (e.g.
# yrx_compiler_max_warnings added in 1.16) that must exist in the
# linked static lib.
